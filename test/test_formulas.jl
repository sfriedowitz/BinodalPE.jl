@testset "formulas" begin
	...
	@test free_energy(phi, model) ≈ -0.11991340426951363
	...
	@test free_energy(phi, model) ≈ -0.03296564824229016
	...
	@test free_energy(phi, model) ≈ -0.06530374287488896
	...
	@test free_energy(phi, model) ≈ -0.0679103840308165
